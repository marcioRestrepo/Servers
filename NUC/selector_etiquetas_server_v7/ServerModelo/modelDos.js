...
let model2, webcam2, labelContainer2, maxPredictions2, targetSend2, cam2, 
    ...
    async function init2() {
        console.log("modelo dos ejecutandose")
    ...
    async function predict2() {
        ...
        if (targetSend2 == 0 & (int_plc2.prediccion == 0 || int_plc2.prediccion == 1)) {
        ...
        if (targetSend2 == 1 & (int_plc2.prediccion != 0 & int_plc2.prediccion != 1)) {
          targetSend2 = 0
          send_data2(int_plc2)
          console.log(int_plc2);
          console.log("defecto")
